...
/*
	controller/UsersController.java - 김기흔
*/
@WebServlet(urlPatterns = {"/users/*"},
initParams = {@WebInitParam(name="view",value="/view/")})

public class UsersController extends MskimRequestMapping{
	...
	public String login(HttpServletRequest request, HttpServletResponse response) {			
		...
		Users user = dao.selectOne(user_no);
		String msg = null;
		String url = null;
	...
	public String id(HttpServletRequest request, HttpServletResponse response) {
		...
		String user_no = dao.userSearch(name, email);	
	...
	public String info(HttpServletRequest request, HttpServletResponse response) {
		String login = (String) request.getSession().getAttribute("user_no");
		Users user = dao.selectOne(login);
