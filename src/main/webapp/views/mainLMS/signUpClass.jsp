...
<body>
	<h2>수강 신청</h2>
	<form action="signUpClass" method="get">
		<select name="column">
	...
	<input type="text" name="fine" placeholder="Search">
	...
	<table>
		...
		<c:forEach var="i" begin="1" end="5">
			<tr>
				...
				<td style="text-align: center">월<br>09:00~11:00	</td>
				<td style="text-align: center">A관 101호</td>
				<td style="text-align: center">11/20</td>
				<td style="text-align: center"><button type="submit">신청</button></td>
			</tr>
		</c:forEach>
	</table>
</body>
